            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->role == 'teacher')
                        ...
                        <x-nav-link :href="route('teacher.contents.index')" :active="request()->routeIs('teacher.contents.index')">
                            {{ __('Manage Contents') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role == 'teacher')
                ...
                <x-responsive-nav-link :href="route('teacher.contents.index')" :active="request()->routeIs('teacher.contents.index')">
                    {{ __('Manage Contents') }}
                </x-responsive-nav-link>
            @endif
            @auth
                @if(auth()->user()->role == 'student')
                    <ul>
                        ...
                        <li><a href="{{ route('student.courses.index') }}">Semua Kursus</a></li>
                        <li><a href="{{ route('student.dashboard') }}">Kursus yang Diikuti</a></li>
                    </ul>
                @endif
            @endauth
        </div>
